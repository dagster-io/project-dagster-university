...
from dagster_and_dbt.completed.lesson_7.defs.assets.dbt import dbt_analytics
from dagster_and_dbt.completed.lesson_7.defs.partitions import weekly_partition
