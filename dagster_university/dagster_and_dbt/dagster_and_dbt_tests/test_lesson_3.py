...
def test_dbt_assets(setup_dbt_env):  # noqa: F811
    from dagster_and_dbt.completed.lesson_3.defs.assets import dbt
    from dagster_and_dbt.completed.lesson_3.defs.resources import dbt_resource
...
def test_def_can_load(setup_dbt_env):  # noqa: F811
    from dagster_and_dbt.completed.lesson_3.definitions import defs
