...
def test_dbt_partitioned_incremental_assets(setup_dbt_env):  # noqa: F811
    from dagster_and_dbt.completed.lesson_6.assets import dbt
    from dagster_and_dbt.completed.lesson_6.resources import dbt_resource
...
def test_def_can_load(setup_dbt_env):  # noqa: F811
    from dagster_and_dbt.completed.lesson_6.definitions import defs
