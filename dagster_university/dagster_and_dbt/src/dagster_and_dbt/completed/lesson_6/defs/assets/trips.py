...
from src.dagster_and_dbt.completed.lesson_6.defs.partitions import monthly_partition
from src.dagster_and_dbt.completed.lesson_6.defs.resources import smart_open_config
