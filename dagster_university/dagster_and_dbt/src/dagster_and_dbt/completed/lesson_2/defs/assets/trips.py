...
from src.dagster_and_dbt.completed.lesson_2.defs.partitions import monthly_partition
from src.dagster_and_dbt.completed.lesson_2.defs.resources import smart_open_config
