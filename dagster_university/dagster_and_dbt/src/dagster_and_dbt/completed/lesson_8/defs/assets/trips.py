...
from dagster_and_dbt.completed.lesson_8.defs.partitions import monthly_partition
from dagster_and_dbt.completed.lesson_8.defs.resources import smart_open_config
