...
Dagster provides several built-in components for ETL workflows:

| Component | Use Case |
|-----------|----------|
| `dagster_sling.SlingReplicationCollectionComponent` | Database-to-database replication |
| `dagster_dbt.DbtProjectComponent` | dbt transformations |

{% callout type="note" title="Components Are Evolving" %}
Dagster Components is a relatively new feature and is actively being developed. Check the [Dagster documentation](https://docs.dagster.io/guides/build/components/) for the latest available components and their APIs.
{% /callout %}
