...
You'll build the first layer of the ELT pipeline from Lesson 1's project preview: the three raw assets that load customer, order, and payment data into DuckDB. By the end of this lesson you'll have a working, validated Dagster project with a daily schedule—the foundation that Lesson 5 will build on with dbt and Sling.
