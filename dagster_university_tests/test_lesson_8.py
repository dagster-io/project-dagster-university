...
from dagster_university.lesson_8.assets import trips, metrics
from dagster_university.lesson_8.definitions import defs
from dagster_university.lesson_8.jobs import (
    adhoc_request_job,
    trip_update_job,
    weekly_update_job,
)
from dagster_university.lesson_8.resources import database_resource
from dagster_university.lesson_8.schedules import (
