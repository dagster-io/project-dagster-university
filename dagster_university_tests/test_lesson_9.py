...
from dagster_university_tests.fixtures import drop_tax_trips_table  # noqa: F401
from dagster_university.lesson_9.assets import trips, metrics
from dagster_university.lesson_9.definitions import defs
from dagster_university.lesson_9.jobs import (
    adhoc_request_job,
    trip_update_job,
    weekly_update_job,
)
from dagster_university.lesson_9.resources import database_resource
from dagster_university.lesson_9.schedules import (
    trip_update_schedule,
    weekly_update_schedule,
)
from dagster_university.lesson_9.sensors import (
